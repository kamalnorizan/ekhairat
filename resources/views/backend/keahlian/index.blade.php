                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }} form-group-default ">
                                ...
                                {!! Form::select(
                                    'status',
                                    ['' => 'Pilih Status Keahlian', 'Aktif' => 'Aktif', 'Tidak Aktif' => 'Tidak Aktif'],
                                    '',
                        ...
                        <div class="col-md-4">
                            <div class="form-group{{ $errors->has('jenis') ? ' has-error' : '' }} form-group-default ">
                                ...
                                {!! Form::select('jenis', $kategoriKeahlian, null, [
                                    'id' => 'jenis',
                                    'class' => 'form-control',
                                    'required' => 'required',
                                ]) !!}
...
@section('script')
    ...
    <script>
        ...
        $(document).on("click", ".btn-pdm", function(e) {
            var id = $(this).data('id');
            swal({
                title: "Adakah anda pasti?",
                text: "Rekod ahli ini akan dipadamkan secara kekal dan tudak dapat diundurkan semula.",
                icon: "warning",
                buttons: {cancel: {
                    text: "Batal",
                    value: null,
                ...
                if(value){
                    $.ajax({
                        type: "post",
                        url: "{{ route('keahlianadm.deleteKeahlian') }}",
                        data: {
                            _token: '{{csrf_token()}}',
                            id: id
                        },
                        ...
                        success: function (response) {
                            swal("Deleted!", "Rekod keahlian telah berjaya dipadam.", "success");
