									...
									<form id="login-form" name="login-form" class="mb-0" action="{{route('login')}}" method="post">
										...
										<div class="row">
											<div class="col-12 form-group">
												...
												<input type="text" id="nokp" name="nokp" value="" class="form-control not-dark" />
											</div>
											...
											<div class="col-12 form-group">
												...
												<button type="submit" class="button button-3d button-black m-0" id="login-form-submit" name="login-form-submit" value="login">Log Masuk</button>
												<a href="{{route('forget.password.get')}}" class="float-end">Lupa Kata Laluan?</a>
											</div>
										</div>
									</form>
								</div>
