      ...
      <div class="card cardDiv" data-type="asnaf"  style="border-bottom: 10px solid #927400">
        <div class="card-content">
          <div class="card-body">
            <div class="media d-flex">
              <div class="align-self-center">
                <i class="fa fa-street-view fa-5x text-warning font-large-2 float-left" aria-hidden="true"></i>
              </div>
              <div class="media-body text-right">
                <h3>{{$asnaf->ahli_count}}
                    </h3>
    ...
    <div class="col-md-4">
        <div class="card bg-success">
            <div class="card-body">
                ...
                <a href="#" class="text-white"><span class="">{{$alamatDiv->keterangan}}</span><span class="float-right">{{$alamatDiv->ahli_count}} <small>ahli</small></span></a><br>
                @endforeach
            </div>
        </div>
