...
<section id="page-title" class="page-title-center">
    ...
    <div class="container clearfix">
        ...
        <ol class="breadcrumb">
            ...
            @elseif ($type=='n')
                <li class="breadcrumb-item"><a href="#">Pendaftaran Keahlian</a></li>
            @else
                            ...
                            <div class="card-body">
                                ...
                                <input type="hidden" name="type" id="type" class="form-control" value="{{ $type }}">
                                    ...
                                    <div class="row">
                                        ...
                                        @elseif ($type == 'p')
                                            <div class="col-md-12 text-center">
                                                <button class="btn btn-primary" type="button" id="btnPembayaran">Daftar Keahlian</button>
                                            </div>
                                        @else
                                            <div class="col-md-12 text-center">
                                                <button class="btn btn-primary" type="button" id="btnPembayaran">Daftar Keahlian</button>
